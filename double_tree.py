...
class FlatRectanguloidDoubleTree(object): 
    ...
    def __init__(self, x1, y1, z1, x2, y2, z2,  
        ...
        ----------
        x1, y1, z1 : arrays
            Length-*Npts1* arrays containing 
            the spatial position of the *Npts1* points. 

        x2, y2, z2 : arrays
            Length-*Npts2* arrays containing 
            the spatial position of the *Npts2* points. 
        ...
        approx_x2cell_size, approx_y2cell_size, approx_z2cell_size : float 
            An entirely separate tree is built 
            for the *Npts2* points, the structure of which 
            is dependent on the struture of the *Npts1* tree as described below. 
        ...
        search_xlength, search_ylength, search_zlength, floats, optional
            ...
            `~halotools.mock_observables.pair_counters.FlatRectanguloidDoubleTree` 
            to compute a 3-D correlation function with radial separation bins 
            *rbins = [0.1, 1, 10, 25]*, then in this case 
            all the search lengths will equal 25. If using 
            `~halotools.mock_observables.pair_counters.FlatRectanguloidDoubleTree` 
            in a projected correlation function 
            with *rp_bins = [0.1, 1, 10, 25]* and 
        ...
        PBCs : bool, optional 
            ...
            the box has periodic boundary conditions. 
            Default is True. 
        """
        self.xperiod = xperiod 
        self.yperiod = yperiod 
        ...
        print('Cell1 size = %f' % self.x1cell_size)
        print('Cell2 size = %f' % self.x2cell_size)
    ...
    def _check_sensible_constructor_inputs(self):
        ...
        try:
            ...
            msg = ("\n The maximum length over which "
                "you search for pairs of points \n"
